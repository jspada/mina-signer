...
fn keypair_tests() {
    macro_rules! assert_get_address_eq {
        ($sec_key_hex:expr, $target_address:expr) => {
            let kp = Keypair::from_sec_key_hex($sec_key_hex).expect("failed to create keypair");
    ...
    assert_eq!(Keypair::from_sec_key_hex(""), Err("invalid secret key hex length"));
    assert_eq!(Keypair::from_sec_key_hex("1428fadcf0c02396e620f14f176fddb5d769b7de2027469d027a80142ef8f07"), Err("invalid secret key hex length"));
    assert_eq!(Keypair::from_sec_key_hex("0f5314f176fddb5d769b7de2027469d027ad428fadcf0c02396e6280142efb7d8"), Err("invalid secret key hex length"));
    assert_eq!(Keypair::from_sec_key_hex("g64244176fddb5d769b7de2027469d027ad428fadcf0c02396e6280142efb7d8"), Err("failed to decode secret key hex"));
    assert_eq!(Keypair::from_sec_key_hex("dd4244176fddb5d769b7de2027469d027ad428fadcc0c02396e6280142efb718"), Err("failed to deserialize secret key bytes"));
